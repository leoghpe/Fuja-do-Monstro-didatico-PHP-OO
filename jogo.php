...
public function executarJogo($posicaoDesejada){
	...
	$this->personagemJogador->mover($this->mapa->obterCaracterePosicao($posicaoDesejada), $posicaoDesejada);
        ...
        if($zerarJogo){
                ...
                $this->historicoJogo->setNumeroVidas($this->personagemJogador->getVida());
        ...
        $retorno = '<table align=center border=1 >
                ...
                while($historicoJogoBanco = array_shift($historicosJogos)){
                 ...
                 $retorno .= '<tr>
                                ...
                                <td align=center>'.$historicoJogoBanco->getNumeroVidas().' </td>
                        </tr>';
                        }
                $retorno .= '</table> ';
...
public function renderizarMapa(){
        ...
        //$this->html_saida .= '<div  style="width:1300px; float:left; margin-top:5px">';
        //$this->html_saida .= '<div  style="float:left">';
        ...
        //$this->html_saida .= '<div style="width:589px; float:right; margin-top:5px">';
        //$this->html_saida .= '<div style=" float:right">';
