...
class RepositorioHistoricoJogo implements IRepositorioHistoricoJogo {
		...
		public function cadastrarHistoricoJogo($historicoJogo){
			...
			$numeroVidas = $historicoJogo->getNumeroVidas();
			
			$sql = "INSERT INTO historicojogo (data, inicioDuracao, finalDuracao, duracao, numeroVidas) VALUES
			('$data', 
                        '$inicioDuracao', 
                        '$finalDuracao', 
                        '$duracao', '$numeroVidas')";
		...
		public function listarHistoricoJogo(){
			...
			while($linha = mysqli_fetch_array($listagem)){
			        ...
			        $this->historicojogo->setNumeroVidas($linha['numeroVidas']);
